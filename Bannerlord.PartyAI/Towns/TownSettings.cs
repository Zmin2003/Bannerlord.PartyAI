...
public class TownSettings
{
    ...
    [SaveableProperty(2)] public TownStrategy DefaultStrategy { get; set; } = TownStrategy.Balanced;
    ...
    /// <summary>Superseded by the global <see cref="Core.ModSettings.GoldReserve"/>; kept so old saves load and migrate.</summary>
    [SaveableProperty(6)] public int PlayerGoldReserve { get; set; } = 20000;
    ...
    [SaveableProperty(28)] public DefensePriority DefaultDefensePriority { get; set; } = DefensePriority.Normal;
    ...
    public TownSettings(TownSettings source)
    {
    ...
    public TownSettings DeepCopy() => new(this);

    public void Normalize()
    {
        if (DefaultStrategy < TownStrategy.Balanced || DefaultStrategy > TownStrategy.Military)
        {
            DefaultStrategy = TownStrategy.Balanced;
        }
        ...
        if (DefaultDefensePriority < DefensePriority.Low || DefaultDefensePriority > DefensePriority.Critical)
        {
            DefaultDefensePriority = DefensePriority.Normal;
        }
