...
public class AutoDefenseAssignment
{
    ...
    [SaveableProperty(7)] public PartyAiOrder? SuspendedOrder { get; private set; }
    [SaveableProperty(8)] public List<PartyAiOrder> SuspendedQueue { get; private set; }
        ...
        int automationToken)
    {
        ...
        SuspendedOrder = suspendedOrder is null ? null : new PartyAiOrder(suspendedOrder);
        SuspendedQueue = suspendedQueue.Select(order => new PartyAiOrder(order)).ToList();
